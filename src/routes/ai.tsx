  ...
  head: () => ({
    meta: [
      { title: "AI Studio | Music AI" },
      {
        name: "description",
        content:
          "Record your voice and let the AI build a full song around it, with cover art and a 24-hour mining bonus.",
      },
      { property: "og:title", content: "AI Studio | Music AI" },
      {
        property: "og:description",
        content: "Turn your voice into a song with AI, right inside Telegram.",
      },
    ],
  }),
  component: AiPage,
