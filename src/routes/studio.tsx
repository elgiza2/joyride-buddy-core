...
export const Route = createFileRoute("/studio")({
  head: () => ({
    meta: [
      { title: "Music NFTs | Music AI" },
      {
        name: "description",
        content:
          "Collect Music NFTs — playable records that permanently mine MUSIC, GRAM and USDT for you.",
      },
      { property: "og:title", content: "Music NFTs | Music AI" },
      { property: "og:description", content: "Playable NFT records that mine three coins." },
    ],
  }),
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-2 px-4">
              {[
                ...
                { icon: <CoinIcon id="gram" size={14} />, label: "GRAM", v: formatCrypto(daily.gram) },
                { icon: <CoinIcon id="usdt" size={14} />, label: "USDT", v: formatCrypto(daily.usdt) },
              ].map((c) => (
