...
describe("MobileChatHeader", () => {
  ...
  it("renders the rightSlot (upgrade CTA) when there is no conversation", () => {
    renderWithRouter(
      <MobileChatHeader
        {...baseHeaderProps}
        hasConversation={false}
        rightSlot={<button data-testid="mobile-upgrade">Pro</button>}
      />,
    );
  ...
  it("renders header container when there is a conversation", () => {
    ...
    // No rightSlot passed → no upgrade CTA in the header
